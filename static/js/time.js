...
var timeModule = {
  ...
  forceMidnightRefresh: function() {
    ...
    var _refreshTimes = (window.appSettings || DEFAULT_SETTINGS).scheduledRefreshTimes;
    var shouldRefresh = _refreshTimes.some(function(t) {
      return irishHours === t.h && irishMins === t.m && irishSecs <= 2;
    });
