...
def manage_help():
    return render_template('manage/help.html', mosque=MOSQUE_CONFIGS['tralee'])
...
@app.route('/dublin/manage/help/')
def dublin_manage_help():
    return render_template('manage/help.html', mosque=MOSQUE_CONFIGS['dublin'])
